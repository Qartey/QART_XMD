        ...
        if (ms.message.protocolMessage && ms.message.protocolMessage.type === 0) {
            ...
            if (deletedMessage) {
                try {
                    ...
                    const notification = `*🇹🇿QART_XMD🚀. This message was deleted by @${participant.split("@")[0]}*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ QART_XMD is connecting...");
            }
                ...
                console.log("Loading QART_XMD-BOT Commands ...\n");
                fs.readdirSync(__dirname + "/QART_XMD").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/QART_XMD/" + fichier);
